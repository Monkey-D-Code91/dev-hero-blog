...
L'AI ha, per sua natura, un focus ristretto. È straordinaria dentro il contesto che le dai, cieca fuori da quello. Fa benissimo ciò che le inquadri e non sa nulla di ciò che non hai inquadrato. Il rinnovo non è sfuggito all'AI: è sfuggito al contesto che le ho passato. Per questo il lavoro che resta umano non è scrivere il codice, è costruire il contesto: definire il dominio funzionale, dargli confini, costruire gli strumenti per navigarlo. Meno tempo sulle dita, più responsabilità sulla testa.
